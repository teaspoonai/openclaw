...
export const th: TranslationMap = {
  ...
  cron: {
    ...
    runNotStarted: {
      notDue: "การทำงานอัตโนมัตินี้ยังไม่ถึงกำหนด",
      alreadyRunning: "การทำงานอัตโนมัตินี้กำลังทำงานอยู่แล้ว",
      recoveryPending: "การกู้คืนตัวจัดกำหนดการยังอยู่ระหว่างดำเนินการ",
      invalidSpec: "การทำงานอัตโนมัตินี้มีกำหนดการหรือเพย์โหลดที่ไม่ถูกต้อง",
      stopped: "ตัวจัดกำหนดการหยุดทำงานอยู่",
      unknown: "ไม่สามารถเริ่มการทำงานอัตโนมัตินี้ได้",
    },
    jobs: {
      schedule: "กำหนดเวลา",
      lastRun: "ทำงานล่าสุด",
