...
function mount(points: TimeSeriesPoint[], start: number | null, end: number | null) {
...
describe("renderSessionDetailPanel filtered usage", () => {
  it("aggregates token, cost, type, message, and duration data inside the selected range", () => {
    const container = mount(
      [
        point({ timestamp: 1000, totalTokens: 100, cost: 0.1, input: 10, output: 0 }),
        point({ timestamp: 2000, totalTokens: 200, cost: 0.2, input: 0, output: 20 }),
